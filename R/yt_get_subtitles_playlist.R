...
#'
#' @param sub_lang Defaults to "en". If more than one, can be given as comma separated two letter codes, or a as vector.
#' @param write_auto_sub "Write automatically generated subtitle file"
#' @param write_info_json "Write video metadata to a .info.json file (this may contain personal information)"
#' @param min_sleep_interval "Number of seconds to sleep before each download. This is the minimum time to sleep when used along with --max-sleep-interval"
#' @param max_sleep_interval "Maximum number of seconds to sleep. Can only be used along with --min-sleep-interval"
#' @param sleep_subtitles "Number of seconds to sleep before each subtitle download"
...
yt_get_subtitles_playlist <- function(playlist,
                                      ...
                                      sleep_subtitles = 2,
                                      yt_base_folder = NULL) {
  playlist_folder <- yt_get_playlist_folder(playlist = playlist,
